#!/bin/bash
#BSUB -J vidgen1_ultra_apple_right
#BSUB -q gpuv100
#BSUB -W 03:00
#BSUB -R "rusage[mem=4GB]"
#BSUB -gpu "num=1"
#BSUB -o ./assets/ultra_apple_right/logs/ultra_apple_right.out
#BSUB -e ./assets/ultra_apple_right/logs/ultra_apple_right.err
...
mkdir -p assets/ultra_apple_right/logs
export HOME=$PWD
...
python ./generate.py assets/ultra_apple_right/generation_config.yaml
