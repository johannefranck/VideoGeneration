#!/bin/bash
#BSUB -J vidgen1_appledebug
#BSUB -q gpuv100
#BSUB -W 03:00
#BSUB -R "rusage[mem=4GB]"
#BSUB -gpu "num=1"
#BSUB -o ./assets/appledebug/logs/appledebug.out
#BSUB -e ./assets/appledebug/logs/appledebug.err
...
mkdir -p assets/appledebug/logs
export HOME=$PWD
...
python ./generate.py assets/appledebug/generation_config.yaml
