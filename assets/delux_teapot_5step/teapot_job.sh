#!/bin/bash
#BSUB -J vidgen1_delux_teapot_5step
#BSUB -q gpuv100
#BSUB -W 03:00
#BSUB -R "rusage[mem=4GB]"
#BSUB -gpu "num=1"
#BSUB -o ./assets/delux_teapot_5step/logs/delux_teapot_5step.out
#BSUB -e ./assets/delux_teapot_5step/logs/delux_teapot_5step.err
...
mkdir -p assets/delux_teapot_5step/logs
export HOME=$PWD
...
python ./generate.py assets/delux_teapot_5step/generation_config.yaml
