#!/bin/bash
#BSUB -J vidgen1_yoyo_apple_5step
#BSUB -q gpuv100
#BSUB -W 06:00
#BSUB -R "rusage[mem=5GB]"
#BSUB -gpu "num=1"
#BSUB -o ./assets/yoyo_apple_5step/logs/yoyo_apple_5step.out
#BSUB -e ./assets/yoyo_apple_5step/logs/yoyo_apple_5step.err
...
mkdir -p assets/yoyo_apple_5step/logs
export HOME=$PWD
...
python ./generate.py assets/yoyo_apple_5step/generation_config.yaml
