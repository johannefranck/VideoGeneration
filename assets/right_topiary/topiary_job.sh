#!/bin/bash
#BSUB -J vidgen1_right_topiary
#BSUB -q gpuv100
#BSUB -W 03:00
#BSUB -R "rusage[mem=4GB]"
#BSUB -gpu "num=1"
#BSUB -o ./assets/right_topiary/logs/right_topiary.out
#BSUB -e ./assets/right_topiary/logs/right_topiary.err
...
mkdir -p assets/right_topiary/logs
export HOME=$PWD
...
python ./generate.py assets/right_topiary/generation_config.yaml
