#!/bin/bash
#BSUB -J vidgen1_apple_good_flow
#BSUB -q gpuv100
#BSUB -W 06:00
#BSUB -R "rusage[mem=5GB]"
#BSUB -gpu "num=1"
#BSUB -o ./assets/apple_good_flow\logs/apple_good_flow.out
#BSUB -e ./assets/apple_good_flow\logs/apple_good_flow.err
...
mkdir -p assets/apple_good_flow/logs
export HOME=$PWD
...
python ./generate.py assets/apple_good_flow/generation_config.yaml
